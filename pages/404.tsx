    ...
    <div>
      ...
      <main>
        <Box sx={{
          ...
          <Box sx={{width: '30%'}}>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
              ...
              <g>
                ...
                <g id="planet">
                  <circle fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="572.859" cy="108.803"
                          r="90.788"/>
                  <circle id="craterBig" fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10"
                          cx="548.891" cy="62.319" r="13.074"/>
                  <circle id="craterSmall" fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10"
                          cx="591.743" cy="158.918" r="7.989"/>
                  <path id="ring" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round"
                        strokeMiterlimit="10"
			...
			c0-3.378-15.347-4.988-40.243-7.225"/>
                  <path id="ringShadow" opacity="0.5" fill="none" stroke="#fff" strokeWidth="3"
                        strokeLinecap="round"
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"/>
                ...
                <g id="stars">
                  <g id="starsBig">
                    <g>
                      <line fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeMiterlimit="10"
                  ...
                  <g id="circlesBig">
                    <circle fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeMiterlimit="10"
                ...
                <g id="spaceman" clipPath="url(cordClip)">
                  <path id="cord" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round"
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"/>
				...
				M269.678,394.912L269.678,394.912c26.3,20.643,59.654,29.585,93.106,25.724l2.419-0.114"/>
                  ...
                  <g id="head">
                    ...
                    <path id="headStripe" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round"
                          strokeLinejoin="round" strokeMiterlimit="10" d="
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
                    <g clipPath="url(#GlassClip)">
                      <polygon id="glassShine" fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10"
                               points="
          ...
          <Box>
            <Typography sx={{color: 'rgba(255,255,255,0.3)', fontSize: '8em'}}>
              404
            </Typography>
            <Typography>
            ...
            <Typography>
              ...
              <Link onClick={() => router.back()} sx={{cursor: 'pointer'}}>
                Вернуться обратно
              </Link>
            </Typography>
          </Box>
